...
<html lang="en">
  <head>
    ...
    <title>Cont nou - ORGANIZAȚIE</title>
...
<body>
  ...
  <div class="container">
    <br><br><br>
    <h3 class="text-muted">Cont nou <span class="featurette-heading">ORGANIZAȚIE</span></h3>
    <br>
      <div class="col-lg-12 well">
      	<div class="row">
                  ...
                  <div class="row">
                      ...
                      <select class="form-select" name="orasO" id="oras" required></select>
      							</div>
      						</div>
                ...
                <hr class="featurette-divider">
      					...
      					<button type="submit" name="btnOrg" class="btn btn-lg btn-outline-dark" style="margin:auto; display:block; width:50%">Creează cont</button>
                <br><br><br>
      					</div>
      				</form>
      			</div>
