...
while(i < markers.length){
  ...
  if(markers[i][3] == "Donații"){
           ...
           map,
           content: string,
           icon: './assets/imagini/Clusters/donatii.png',
           animation: google.maps.Animation.DROP,
	           ...
	           map,
	           content: string,
	           icon: './assets/imagini/Clusters/cultural.png',
	           animation: google.maps.Animation.DROP,
	            });
	           ...
	           map,
	           content: string,
	           icon: './assets/imagini/Clusters/educational.png',
	           animation: google.maps.Animation.DROP,
	            });
	  }
	           ...
	           map,
	           content: string,
	           icon: './assets/imagini/Clusters/nutritie.png',
	           animation: google.maps.Animation.DROP,
	            });
	  }
	           ...
	           map,
	           content: string,
	           icon: './assets/imagini/Clusters/protectia_mediului.png',
	           animation: google.maps.Animation.DROP,
	            });
	  }
	           ...
	           map,
	           content: string,
	           icon: './assets/imagini/Clusters/religios.png',
	           animation: google.maps.Animation.DROP,
	            });
	  }
	           ...
	           map,
	           content: string,
	           icon: './assets/imagini/Clusters/social.png',
	           animation: google.maps.Animation.DROP,
	            });
	  }
	           ...
	           map,
	           content: string,
	           icon: './assets/imagini/Clusters/sport.png',
	           animation: google.maps.Animation.DROP,
	            });
	  }
