...
var country_arr = new Array("Alba", "Arges", "Arad", "Bucuresti", "Bacau", "Bihor", "Bistrita", "Braila", "Botosani", "Brasov", "Buzau", "Cluj", "Calarasi", "Caras-Severin", "Constanta", "Covasna", "Dambovita", "Dolj", "Gorj", "Galati", "Giurgiu", "Hunedoara", "Harghita", "Ilfov", "Ialomita", "Iasi", "Mehedinti", "Maramures", "Mures", "Neamt", "Olt", "Prahova", "Prahova", "Sibiu", "Salaj", "Satu-Mare", "Suceava", "Tulcea", "Timis", "Teleorman", "Valcea", "Vrancea", "Vaslui");

// States
var s_a = new Array();
s_a[0]="";
s_a[1]="Alba Iulia|Aiud|Blaj|Sebeș|Abrud|Baia de Argeș|Câmpeni|Cugir|A|Helmand|Herat|Jowzjan|Kabol|Kandahar|Kapisa|Konar|Kondoz|Laghman|Lowgar|Nangarhar|Nimruz|Oruzgan|Paktia|Paktika|Parvan|Samangan|Sar-e Pol|Takhar|Vardak|Zabol";
...
function populateStates( countryElementId, stateElementId ){
	...
	stateElement.options[0] = new Option('Alege orașul','');
...
function populateCountries(countryElementId, stateElementId){
	...
	countryElement.options[0] = new Option('Alege județul','-1');
